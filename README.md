...
Current debug build marker: **b058**.
...
- Reload into **b058** and confirm the Comms Radio build marker updates after UMM reload
...
- Test light-engine turnout approach: confirm straight-ish switch moves are not unnecessarily capped, but diverging/tight turnout moves target a lower speed before the switch; if it still enters fast, the remaining issue is braking distance/deceleration
