...
Current debug build marker: **b048**.
...
- DM3 brake smoothing: loaded DM3 speed correction now uses the same capped, ramped service-brake style as steam instead of snapping between release and a large train-brake application
...
- Reload into **b048** and confirm the Comms Radio build marker updates after UMM reload
...
- Test loaded DM3 overspeed braking: confirm it uses a steady service application instead of dumping/releasing the train brake while correcting speed
